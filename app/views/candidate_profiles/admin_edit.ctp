...
<?php echo $this->Form->create('CandidateProfile');?>
	<fieldset>
		<legend><?php __('Admin Edit Candidate Profile'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Html->link(__('Delete', true), array('action' => 'delete', $this->Form->value('CandidateProfile.id')), null, sprintf(__('Are you sure you want to delete # %s?', true), $this->Form->value('CandidateProfile.id'))); ?></li>
